...
public partial class AdminModule : CarbonModule<AdminConfig, AdminData>
{
	...
	private static readonly Dictionary<string, string> SimplifiedChinese = new()
	{
		...
		["Mods"] = "模组",
		["Console"] = "控制台",
		["Execute Server Command"] = "执行服务器命令",
		["Config"] = "配置",
		["Is Modded"] = "标记为 Modded",
		["General"] = "常规",
		["Watchers"] = "监听器",
		["Script Watchers"] = "脚本监听器",
		["ZIP Script Watchers"] = "ZIP 脚本监听器",
		["Script Watchers Option"] = "脚本监听器选项",
		["Logging"] = "日志",
		["Log File Mode"] = "日志文件模式",
		["Log Verbosity (Debug)"] = "日志详细程度（调试）",
		["Log Severity"] = "日志严重级别",
		["Miscellaneous"] = "其他",
		["Server Language"] = "服务器语言",
		["Permission Mode"] = "权限模式",
		["Show Console Info"] = "显示控制台信息",
		["Player Group"] = "玩家组",
		["Admin Group"] = "管理员组",
		["Moderator Group"] = "版主组",
		["Permissions"] = "权限",
		["Debugging"] = "调试",
		["Script Debugging Origin"] = "脚本调试来源",
		["Conditionals"] = "条件编译",
		["Quick Actions"] = "快捷操作",
		["Button Name"] = "按钮名称",
		["Button Command"] = "按钮命令",
		...
		["Secondary"] = "次要",
		["Save immediately"] = "立即保存",
		["Save on change"] = "变更时保存",
		["Save on shutdown"] = "关闭时保存",
		["Normal"] = "普通",
		["Detailed"] = "详细",
		["Minimal"] = "精简",
		["Verbose"] = "冗长",
